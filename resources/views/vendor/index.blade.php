...
<div class="page-content">
    ...
    @if ($status === 'active')
       <h4>
        Vendor account is <span class="text-success">Active</span>
       </h4>
       @else
       <h4>
        Vendor account is <span class="text-danger">Inactive</span>
       </h4>
       <p class="text-danger"> <b> Account approval still pending</b></p>
