...
<div class="d-flex align-items-center">
    ...
    class="msg-time float-end">2 hrs ago</span></h6>
        <p class="msg-info">Your new product has approved</p>
            ...
            @php
                $id = Auth::user()->id;
                $vendor_data = App\Models\User::find($id);
            @endphp


            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($vendor_data->photo)) ? url('uploads/vendorImages/'.$vendor_data->photo) : url('uploads/default.webp') }}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('vendor_profile') }}"><i class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('vendor_change_password') }}"><i class="bx bx-cog"></i><span>Password</span></a>
                    </li>
                    ...
                    <li><a class="dropdown-item" href="{{ route('vendor_logout') }}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </li>
                </ul>
            </div>
        </nav>
