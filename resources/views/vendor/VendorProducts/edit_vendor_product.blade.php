...
@section('title', '| Edit Vendor Products')
...
<form id="myForm" method="post"  action="{{ route('update_vendor_product') }}" >
		@csrf
              ...
              <div class="row g-3">
				...
				<div class="form-group col-md-6">
				  ...
				  <div class="form-group col-md-6">
					...
					<input type="text" name="product_quantity" class="form-control" id="inputStarPoints" value="{{ $products->product_quantity }}">
				  </div>
				  ...
				  <div class="form-group col-12">
					...
					<select name="subcategory_id" class="form-select" id="inputCollection">
						...
						<option value="{{ $sub_cat->id }}" {{ $sub_cat->id == $products->subcategory_id ? 'selected' : '' }} >{{ $sub_cat->subcategory_name }}</option>
						@endforeach
					  </select>
				  </div>
...
<hr>
			...
			{{-- Image Thumbnail  --}}
		<div class="page-content">
			<h6 class="mb-o text-uppercase">Update Thumbnail</h6>
			<hr>
			<div class="card">
				<form enctype="multipart/form-data" method="post"  action="{{ route('update_vendor_product_thumbnail') }}" >
					@csrf
					...
					<div class="card-body">
						<div class="mb-3">
							<label for="formFile" class="form-label">Change Thumbnail</label>
							<input class="form-control" name="product_thumbnail" type="file" id="formFile">
						</div>

						<div class="mb-3">
							<label for="formFile" class="form-label"></label>
							<img src="{{ asset($products->product_thumbnail) }}" alt="productImage" style="width: 100px; height: 100px;">
						</div>
    ...
    <div class="page-content">
        <h6 class="mb-o text-uppercase">Update Multi-Images</h6>
			<hr>
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                        <form enctype="multipart/form-data" method="post"  action="{{ route('update_vendor_product_multi-image') }}" >
                            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset($img->photo_name) }}" alt="Multi-Images" style="width: 70px; height: 50px;">
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete_vendor_multi-image', $img->id) }}" class="btn btn-danger" id="delete" >Delete</a>
                                </td>
                            </tr>
                            @endforeach
