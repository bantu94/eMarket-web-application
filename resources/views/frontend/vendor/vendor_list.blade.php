                    ...
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="{{ route('vendor_details',$vendor->id) }}">
                                <img class="default-img" src="{{ (!empty($vendor->photo)) ? url('uploads/vendorImages/'.$vendor->photo) : url('uploads/default.webp') }}" alt="VendorImage" style="border-top-left-radius: 10%;margin-top:.6rem;" />
                            </a>
                        </div>
