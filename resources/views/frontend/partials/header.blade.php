                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        <li>
                                            <a href="{{ route('dashboard') }}"><i class="fi fi-rs-user mr-10"></i>My Dashboard</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="{{ route('user_logout') }}"><i class="fi fi-rs-sign-out mr-10"></i>Sign out</a>
                                        </li>
                                    </ul>
                                </div>
                                @else
                                ...
                                <a href="{{ route('register') }}"><span class="lable ml-0">Join</span></a>
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                ...
                <div class="hotline d-none d-lg-flex">
                    ...
                    <p>0800-0800<span>24/7 Toll Free Service</span></p>
                </div>
