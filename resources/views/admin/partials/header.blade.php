        ...
        <p class="msg-info">Your new product has approved</p>
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ (!empty($admin_data->photo)) ? url('uploads/images/'.$admin_data->photo) : url('uploads/default.webp') }}" class="user-img" alt="user avatar">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ route('admin_profile') }}"><i class="bx bx-user"></i><span>Profile</span></a>
                    </li>
                    <li><a class="dropdown-item" href="{{ route('admin_change_password') }}"><i class="bx bx-cog"></i><span>Password</span></a>
                    </li>
