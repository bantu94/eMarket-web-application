...
<form id="myForm" method="post"  action="{{ route('update_product') }}" >
		@csrf
...
<hr>
		...
		<div class="page-content">
			...
			<hr>
			<div class="card">
				<form enctype="multipart/form-data" method="post"  action="{{ route('update_product_thumbnail') }}" >
					@csrf
        ...
        <div class="card">
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                        <form enctype="multipart/form-data" method="post"  action="{{ route('update_product_multiImages') }}" >
                            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('delete_multi_image', $img->id) }}" class="btn btn-danger" id="delete" >Delete</a>
                                </td>
                            </tr>
                            @endforeach
