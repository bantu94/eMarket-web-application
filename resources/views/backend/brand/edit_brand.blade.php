        ...
        <div class="main-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('update_brand') }}" id="my_form" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="show_image" src="{{ asset($brand->brand_image) }}" alt="brand_photo"  width="110">
                                    </div>
                                </div>
                                <div class="row">
